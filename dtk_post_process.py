...
def get_reports(data):
    ...
    entry = {'Name': 'NationalPrevalence',
             'Type': 'Prevalence',
             'Year': [2007, 2011, 2016],
             'AgeBins': [ (15, 20), (20, 25), (25, 30), (30, 35), (35, 40), (40, 45), (45, 50), (50, 55), (55, 60), (60, 65)],
             'Gender': [0, 1],
             'ByNode': False,
             'Map': lambda rows: rows.sum(),
             'Reduce': lambda row: float(row.Infected) / float(row.Population) if row.Population > 0 else 0}
    ...
    entry = {'Name': 'NationalARTPrevalence',
             'Type': 'Prevalence',
             'Year': [2011, 2016],
             'AgeBins': [ (15, 25), (25, 35), (35, 45)],
             'Gender': [0, 1],
             'ByNode': False,
             'Map': lambda rows: rows.sum(),
    ...
    entry = {'Name': 'NationalPrevalenceBothGenders',
             'Type': 'Prevalence',
             'Year': [2007, 2012, 2017],
...
#    entries.append(entry)
    ...
    entry = {'Name': 'Population',
             'Type': 'Prevalence',
             'Year': [2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2014.5],
             'AgeBins': [(0, 5), (5, 10), (10, 15), (15, 20), (20, 25), (25, 30), (30, 35), (35, 40), (40, 45), (45, 50), (50, 55), (55, 60), (60, 65), (65, 70), (70, 75), (75, 80), (0,100)],
             'Gender': [0, 1],
             'ByNode': True,
             'Map': lambda rows: rows.sum(),
             'Reduce': lambda row: row.Population}
    ...
    entry = {'Name': 'Number_On_ART',
             ...
             'Year': [2000, 2000.5, 2001, 2001.5, 2002, 2002.5, 2003, 2003.5, 2004, 2004.5, 2005, 2005.5, 2006, 2006.5, 2007, 2007.5, 2008, 2008.5, 2009, 2009.5, 2010, 2010.5, 2011, 2011.5, 2012, 2012.5, 2013, 2013.5],
             'AgeBins': [(0, 15), (15, 100)],
             'Gender': [0, 1],
             'ByNode': True,
             'Map': lambda rows: rows.sum(),

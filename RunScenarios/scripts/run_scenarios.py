...
tpi_csv_filename = "ReEvaluatedLikelihood_full_MASTER_new.csv"
...
plugin_files_dir = os.path.join(current_dir, 'Templates')
...
# Load the campaigns
cpn1 = CampaignTemplate.from_file(os.path.join(plugin_files_dir, 'Campaigns', 'campaign_Swaziland_v05Sep2018_FINAL_reftracktopup_2011_v2.json'))
cpn2 = CampaignTemplate.from_file(os.path.join(plugin_files_dir, 'Campaigns', 'campaign_Swaziland_v05Sep2018_FINAL_reftracktopup_2011_v2_noARTnoVMMC_2.json'))
cpn3 = CampaignTemplate.from_file(os.path.join(plugin_files_dir, 'Campaigns', 'campaign_Swaziland_v05Sep2018_FINAL_reftracktopup_2011_v2_noART_2.json'))
cpn11 = CampaignTemplate.from_file(os.path.join(plugin_files_dir, 'Campaigns', 'campaign_Swaziland_v05Sep2018_FINAL_reftracktopup_2011_v2_100pctART_2.json'))

campaigns = {"cpn1":cpn1, "cpn2":cpn2, "cpn3":cpn3,"cpn11":cpn11}
...
scenarios = [
	 ['noARTnoVMMC_TransmissionReport', "cpn2"],
	 ['100pctART_TransmissionReport', "cpn11"]
     ]
...
config_builder.set_experiment_executable('EMOD_binary_20180921_with_configurable_ART.exe')
...
#                                        output_dir='Test HIV 1'))
    am.add_analyzer(DownloadAnalyzerTPI(['output\\TransmissionReport.csv'], output_dir='ScenariosOct_FINAL'))
